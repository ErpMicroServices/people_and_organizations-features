Feature: Party role types can be create, updated and deleted
  ...
  Scenario: Create a party role type
    Given a party role type with a description of "ChesterTester"
    When I save the party role type
    Then the party role type is in the database

  @party_database
  Scenario: Read a party role type by description
    Given a party role type with a description of "ChesterTester" is in the database
    When I search for a party role type by the description "ChesterTester"
    Then I find the party role type

  @party_database
  Scenario: Update a party role type
    Given a party role type with a description of "ChesterTester" is in the database
    When I update the description of the party role type to "Update ChesterTester"
  ...
  Scenario: I can create a child of a party role type
    Given a party role type with a description of "ChesterTester" is in the database
    When I add a child party role type with a description of "ChesterTester Child"
